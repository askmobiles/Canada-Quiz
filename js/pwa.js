...
(function () {
  ...
  /* An installed app has no address bar, and no address bar means no Back
     ...
     nothing at all. Once you tap into a game inside the installed app there is
     no way back to the menu except closing it, so when we are running as an
     app, we draw our own Back button.
